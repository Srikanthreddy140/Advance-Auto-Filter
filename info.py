...
API_ID = int(environ.get('API_ID', '23695574'))
API_HASH = environ.get('API_HASH', '554032defd6527d556b663ed3e3f7053')
BOT_TOKEN = environ.get('BOT_TOKEN', '6300812532:AAGDakqgBL63SgrSBa9BiFzIvlTvgaRmD44')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002122849060').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://royalsrikanth140:nlSSxVkXkFHArXAF@cluster0.788gy1y.mongodb.net/?retryWrites=true&w=majority")
